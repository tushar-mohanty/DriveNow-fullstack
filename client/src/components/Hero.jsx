...
const Hero = () => {
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        ...
        animate={{y:0, opacity:1}}
        transition={{duration:0.8, delay:0.2}}className='text-4xl md:text-5xl mt-14 font-semibold'>Take your dream car for a ride</motion.h1>
        ...
        transition={{duration:0.8, delay:0.6}}
         src={assets.important_car} alt="car" className='max-h-90'/>
